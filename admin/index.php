...
$COUNT_VEHICLE = count(Vehicle::all());
                        ...
                        <div class="card">
                            <div class="header bg-blue-grey">
                                ...
                                <ul class="header-dropdown m-r--5">
                                    <div class="number count-to" data-from="0" data-to=" <?php echo $COUNT_VEHICLE; ?>" data-speed="1500" data-fresh-interval="1"></div>
                                </ul>
                            </div>
                            <div class="body">
                                <div class="list-group">
                                    ...
                                    <a href="arrange-vehicle.php"><button type="button" class="list-group-item">Arrange</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
